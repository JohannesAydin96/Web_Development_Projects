...
public class User {
    ...
    // Constructor with fields (without role - for backward compatibility)
    ...
    public User(int id, String username, String password, String email, Timestamp createdAt, String role) {
        this.id = id;
        this.username = username;
        this.password = password;
        this.email = email;
